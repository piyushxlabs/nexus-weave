...
<div align="center">
  ...
  <p><em>Real-time isolation of the 3-node cyclic deadlock between Order Service, Payment Gateway, and Notification Service.</em></p>
</div>
...
```typescript
// src/tools/schemas/minimizeEdgeCrossings.schema.ts — compiled Ajv inputSchema
